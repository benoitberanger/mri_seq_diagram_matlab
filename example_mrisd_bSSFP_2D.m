...
G_SSpre.set_moment(G_SSset.get_rewind_moment()); % will set all .dur*, but no .onset or .offset
...
% save the fig :
% DIAGRAM.save_fig('diagram_bSSFP_2D.png')
% DIAGRAM.save_fig('diagram_bSSFP_2D.svg')
